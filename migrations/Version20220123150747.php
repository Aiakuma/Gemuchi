 ...
 */
final class Version20220123150747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE note (id INT AUTO_INCREMENT NOT NULL, musique DOUBLE PRECISION NOT NULL, absencebug DOUBLE PRECISION NOT NULL, tempschargement DOUBLE PRECISION NOT NULL, bruitage DOUBLE PRECISION NOT NULL, originalite DOUBLE PRECISION NOT NULL, rendementhoraire DOUBLE PRECISION NOT NULL, phasejeu DOUBLE PRECISION NOT NULL, chargeemotionnelle DOUBLE PRECISION NOT NULL, narration DOUBLE PRECISION NOT NULL, pertinencepartipris DOUBLE PRECISION NOT NULL, diversitenuance DOUBLE PRECISION NOT NULL, gestiondifficulte DOUBLE PRECISION NOT NULL, efficaciteinterface DOUBLE PRECISION NOT NULL, disponibilite DOUBLE PRECISION NOT NULL, messageautocritique DOUBLE PRECISION NOT NULL, integrationmessage DOUBLE PRECISION NOT NULL, coupdecoeur DOUBLE PRECISION NOT NULL, synergie DOUBLE PRECISION NOT NULL, ressourcemateriel DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE test (id INT AUTO_INCREMENT NOT NULL, son LONGTEXT NOT NULL, code LONGTEXT NOT NULL, gameplay LONGTEXT NOT NULL, rythme LONGTEXT NOT NULL, scenario LONGTEXT NOT NULL, graphisme LONGTEXT NOT NULL, accessibilite LONGTEXT NOT NULL, disponibilite LONGTEXT NOT NULL, ouverturereflexion LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
