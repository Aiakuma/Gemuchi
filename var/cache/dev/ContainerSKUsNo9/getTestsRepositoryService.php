 ...
 */
class getTestsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TestsRepository' shared autowired service.
     *
     * @return \App\Repository\TestsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TestsRepository.php';

        return $container->privates['App\\Repository\\TestsRepository'] = new \App\Repository\TestsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
