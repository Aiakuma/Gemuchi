 ...
 */
class getConsolesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ConsolesRepository' shared autowired service.
     *
     * @return \App\Repository\ConsolesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ConsolesRepository.php';

        return $container->privates['App\\Repository\\ConsolesRepository'] = new \App\Repository\ConsolesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
